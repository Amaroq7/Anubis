...
namespace Metamod::Engine
{
    ...
    public:
        ...
        void queryClientCvarValue(const IEdict *player, std::string_view cvarName, FuncCallType callType) const final;
        void queryClientCvarValue2(const IEdict *player, std::string_view cvarName, std::uint32_t requestID, FuncCallType callType) const final;
