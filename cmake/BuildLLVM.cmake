...
FetchContent_Declare(
        ...
        GIT_SHALLOW    ON
        SOURCE_DIR     ${CMAKE_BINARY_DIR}/_deps/libunwind
)
...
export(TARGETS unwind_shared unwind_static FILE "${libunwind_BINARY_DIR}/unwind-targets.cmake")
...
FetchContent_Declare(
        ...
        GIT_TAG        origin/master
        GIT_SHALLOW    ON
        SOURCE_DIR     ${CMAKE_BINARY_DIR}/_deps/libcxxabi
)
...
FetchContent_Declare(
        ...
        GIT_TAG        origin/master
        GIT_SHALLOW    ON
        SOURCE_DIR     ${CMAKE_BINARY_DIR}/_deps/libcxx
)
...
set(LIBCXXABI_LIBUNWIND_INCLUDES "${libunwind_SOURCE_DIR}/include" CACHE PATH
        "Specify path to libunwind includes." FORCE)
set(LIBCXXABI_LIBUNWIND_PATH "${libunwind_SOURCE_DIR}" CACHE PATH
        "Specify path to libunwind source." FORCE)

set(LIBCXXABI_LIBCXX_INCLUDES ${libcxx_SOURCE_DIR}/include CACHE INTERNAL "")
set(LIBCXX_CXX_ABI_INCLUDE_PATHS ${libcxxabi_SOURCE_DIR}/include CACHE INTERNAL "")
set(LIBCXX_HAS_PTHREAD_API ON CACHE INTERNAL "")

add_subdirectory(${libcxxabi_SOURCE_DIR} ${libcxxabi-llvm_BINARY_DIR})
add_subdirectory(${libcxx_SOURCE_DIR} ${libcxx-llvm_BINARY_DIR})
...
export(TARGETS cxxabi_shared cxxabi_static FILE "${libcxxabi_BINARY_DIR}/cxxabi-targets.cmake")
...
export(TARGETS cxx_shared cxx_static FILE "${libcxx_BINARY_DIR}/cxx-targets.cmake")
export(PACKAGE cxx)
...
set(LIBCXXABI_INCLUDE_HEADERS "${libcxxabi_SOURCE_DIR}/include")
set(LIBCXX_INCLUDE_HEADERS "${libcxx_SOURCE_DIR}/include")
