...
namespace Anubis::Game::Valve
{
    ...
    private:
        ...
        t_ret execFunc(std::string_view fnName, t_args... args) const
        {
            ...
            static auto fn = gConfig->getAddressFn<t_ret, void *, t_args...>(fnName, "CBasePlayerItem");
            return fn(operator CBasePlayerItem *(), args...);
#else
            static auto fn = gConfig->getAddressFn<t_ret, void *, int, t_args...>(fnName, "CBasePlayerItem");
            return fn(operator CBasePlayerItem *(), 0, args...);
#endif
        }
    };
} // namespace Anubis::Game::Valve
