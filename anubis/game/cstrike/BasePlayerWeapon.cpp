...
namespace Anubis::Game::CStrike
{
    ...
    void BasePlayerWeapon::sendWeaponAnim(int iAnim, bool skipLocal, int body [[maybe_unused]]) const
    {
        operator ::CBasePlayerWeapon *()->SendWeaponAnim(iAnim, static_cast<int>(skipLocal));
    }
