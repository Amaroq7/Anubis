...
namespace
{
    ...
    {
        std::invoke(engFuncs->pfnServerPrint,
                    fmt::vformat(format, fmt::make_args_checked<t_args...>(format, args...)).c_str());
    }
    ...
    {
        std::invoke(engFuncs->pfnServerPrint,
                    fmt::vformat(ts, format, fmt::make_args_checked<t_args...>(format, args...)).c_str());
    }
    ...
    void serverPrint(std::string_view format, t_args... args)
    {
        ...
        engLib->print(fmt::vformat(format, fmt::make_args_checked<t_args...>(format, args...)),
